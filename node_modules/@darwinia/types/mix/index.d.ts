...
export declare const jsonrpc: Record<string, Record<string, import("@polkadot/types/types").DefinitionRpcExt>>;
export declare const typesBundleForPolkadot: {
    spec: {
        crab: {
            alias: {};
            rpc: Record<string, Record<string, import("@polkadot/types/types").DefinitionRpcExt>>;
            types: {
