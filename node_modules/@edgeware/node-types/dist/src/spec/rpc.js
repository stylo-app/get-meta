...
function default_1() {
    function generateDescription(description, returnType, params = []) {
        return {
            description,
            params,
            type: returnType
    ...
    const numberParam = { isOptional: true, name: 'number', type: 'BlockNumber' };
    const hashParam = { name: 'hash', type: 'H256' };
    const reqParam = { name: 'request', type: 'CallRequest' };
    const blockParam = { name: 'block', type: 'BlockNumber' };
    const addressParam = { name: 'address', type: 'H160' };
    const indexParam = { name: 'index', type: 'U256' };
    return {
        eth: {
