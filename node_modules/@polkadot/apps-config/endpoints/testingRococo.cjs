...
exports.createRococo = createRococo;
...
function createRococo(t) {
  return (0, _util.expandEndpoints)(t, [{
    dnslink: 'rococo',
    ...
    }, // add any additional parachains here, alphabetical
    {
      info: 'rococoAres',
      paraId: 6,
      text: t('rpc.rococo.ares', 'Ares PC1', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      info: 'rococoBifrost',
      paraId: 107,
      text: t('rpc.rococo.bifrost', 'Bifrost PC1', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      paraId: 8888,
      text: t('rpc.rococo.bitcountry', 'Bit.Country PC1', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      info: 'rococoClover',
      paraId: 229,
      text: t('rpc.rococo.clover', 'Clover PC1', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      info: 'rococoCrust',
      paraId: 7777,
      text: t('rpc.rococo.crust', 'Crust PC1', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      info: 'rococoChainX',
      paraId: 59,
      text: t('rpc.rococo.chainx', 'ChainX PC1', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      info: 'rococoDarwinia',
      paraId: 18,
      text: t('rpc.rococo.darwinia', 'Darwinia PC2', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      paraId: 2,
      text: t('rpc.rococo.datahighway', 'DataHighway', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      paraId: 1862,
      text: t('rpc.rococo.encointer', 'Encointer PC1', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      info: 'rococoHydrate',
      paraId: 82406,
      text: t('rpc.rococo.hydrate', 'Hydrate', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      info: 'rococoIdavoll',
      paraId: 7766,
      text: t('rpc.rococo.idavoll', 'Idavoll', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      paraId: 1983,
      text: t('rpc.rococo.integritee', 'IntegriTEE PC1', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      info: 'rococoJupiter',
      paraId: 1,
      text: t('rpc.rococo.jupiter', 'Patract Jupiter R1', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      info: 'rococoKilt',
      paraId: 12623,
      text: t('rpc.rococo.kilt', 'KILT PC1', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      info: 'rococoAcala',
      paraId: 666,
      text: t('rpc.rococo.acala', 'Mandala PC2', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      paraId: 40,
      text: t('rpc.rococo.mathchain', 'MathChain PC1', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      info: 'rococoPhala',
      paraId: 30,
      text: t('rpc.rococo.phala', 'Phala PC1', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      info: 'rococoPlasm',
      paraId: 5000,
      text: t('rpc.rococo.plasm', 'Plasm PC2', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      info: 'rococoPolkabtc',
      paraId: 21,
      text: t('rpc.rococo.polkabtc', 'PolkaBTC PC1', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      paraId: 3000,
      text: t('rpc.rococo.robonomics', 'Robonomics PC2', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      info: 'rococoSubDAO',
      paraId: 888,
      text: t('rpc.rococo.subdao', 'SubDAO PC1', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      paraId: 6633,
      text: t('rpc.rococo.trustbase', 'TrustBase PC1', {
        ns: 'apps-config'
      }),
      providers: {
      ...
      info: 'rococoZenlink',
      paraId: 188,
      text: t('rpc.rococo.zenlink', 'Zenlink PC1', {
        ns: 'apps-config'
      }),
      providers: {
