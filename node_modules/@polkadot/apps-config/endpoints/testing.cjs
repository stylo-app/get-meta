...
function createTesting(t) {
  return (0, _util.expandEndpoints)(t, [// alphabetical based on chain name, e.g. Amber, Arcadia, Beresheet, ...
  {
    info: 'centrifuge',
    ...
    info: 'bitcountry',
    text: t('rpc.bitcountry', 'Bit.Country Tewai', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'bifrost',
    text: t('rpc.bifrost', 'Bifrost Asgard', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'clover',
    text: t('rpc.clover.finance', 'Clover', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'crust',
    text: t('rpc.crust.network', 'Crust Maxwell', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    text: t('rpc.encointer.cantillon', 'Encointer Cantillon', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    text: t('rpc.encointer.gesell', 'Encointer Gesell', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'equilibrium',
    text: t('rpc.equilibriumtestnet', 'Equilibrium', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'moonbaseAlpha',
    text: t('rpc.moonbeam', 'Moonbase Alpha', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'sora-substrate',
    text: t('rpc.sora-substrate', 'SORA-staging', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'ternoa-chaos',
    text: t('rpc.ternoa-chaos', 'Ternoa Chaos', {
      ns: 'apps-config'
    }),
    providers: {
