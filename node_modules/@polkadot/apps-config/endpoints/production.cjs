...
function createProduction(t) {
  return (0, _util.expandEndpoints)(t, [// fixed, polkadot
  {
    dnslink: 'polkadot',
    info: 'polkadot',
  ...
  }, // alphabetical based on chain name
  {
    ...
    info: 'equilibrium',
    text: t('rpc.equilibrium', 'Equilibrium', {
      ns: 'apps-config'
    }),
    providers: {
    ...
    info: 'hanonycash',
    text: t('rpc.hanonycash', 'Hanonycash', {
      ns: 'apps-config'
    }),
    providers: {
