...
import nodeZero from "./nodes/zero.svg"; // last-resort fallback, just something empty

import emptyLogo from "./empty.svg"; // Alphabetical overrides based on the actual matched chain name
// NOTE: This is as retrieved via system.chain RPC

export const chainLogos = [['Ares PC1', nodeAres], ['Crust PC1', nodeCrust], ['ChainX', nodeChainx], ['darwinia crab', nodeCrab], ['Darwinia PC2', nodeDarwinia], ['DataHighway', nodeDataHighway], ['Dusty', chainDusty], ['Galois', nodeMath], ['HydraDX Hydrate', chainHydrate], ['HydraDX Snakenet', chainSnakenet], ['Encointer PC1', nodeEncointerNotee], ['Idavoll', nodeIdavoll], ['IntegriTEE PC1', nodeIntegritee], ['Jupiter A1', nodeJupiter], ['Jupiter PC1', nodeJupiter], ['KILT PC1', nodeKilt], ['Kusama', chainKusama], // new name after CC3
['Kusama CC1', chainKusama], ['Kusama CC2', chainKusama], ['Kusama CC3', chainKusama], ['MathChain PC1', nodeMath], ['Moonbase Alpha', moonbeam], ['Moonbase Stage', moonbeam], ['Moonbase Development Testnet', moonbeam], ['PolkaBTC', nodePolkaBTC], ['PolkaBTC Staging', nodePolkaBTC], ['Polkadex Testnet', nodePolkadex], ['Phala PC1', nodePhala], ['Rococo', chainRococo], ['Sgc', nodeSgc], ['Tick', chainRococoTick], ['Track', chainRococoTrack], ['Trick', chainRococoTrick], ['TrustBase PC1', nodeTrustBase], ['Uniarts', nodeUniarts], ['Unique', chainUnique]].reduce((logos, [chain, logo]) => _objectSpread(_objectSpread({}, logos), {}, {
  [chain.toLowerCase()]: logo
}), {}); // Alphabetical overrides based on the actual software node type
// NOTE: This is as retrieved via system.name RPC

export const nodeLogos = [['Acala Node', nodeAcala], ['Ares Node', nodeAres], ['Ares Parachain Collator', nodeAres], ['mandala node', nodeAcala], ['airalab-robonomics', nodeRobonomics], ['Bifrost Node', nodeBifrost], ['Bifrost', nodeBifrost], ['BitCountry Node', nodeBitCountry], ['Bit.Country', nodeBitCountry], ['Bit Country Tewai Parachain Collator', nodeBitCountry], ['Canvas Node', nodeCanvas], ['centrifuge chain', nodeCentrifuge], ['Centrifuge Chain Node', nodeCentrifuge], ['ChainX Node', nodeChainx], ['Clover Node', nodeClover], ['darwinia crab', nodeCrab], ['crust', nodeCrust], ['Crust Collator', nodeCrust], ['darwinia', nodeDarwinia], ['darwinia parachain', nodeDarwinia], ['Darwinia Runtime Module Library', nodeDarwinia], ['DataHighway', nodeDataHighway], ['DataHighway Node', nodeDataHighway], ['DataHighway Parachain Collator', nodeDataHighway], ['Dock Full Node', nodeDockMainnet], ['DOTMog Node', nodeDotMog], ['Edgeware Node', nodeEdgeware], ['Encointer Node', nodeEncointerNotee], ['Encointer Node noTEE', nodeEncointerNotee], ['Encointer Node TEE proxy', nodeEncointerTeeproxy], ['Galois', nodeMath], ['hanonycash', nodeHanonycash], ['Idavoll Node', nodeIdavoll], ['KILT Node', nodeKilt], ['KILT Collator', nodeKilt], ['kulupu', nodeKulupu], ['Laminar Node', nodeLaminar], ['Litentry Collator', nodeLitentry], ['node-template', nodeSubstrate], ['Nodle Chain Node', nodeNodle], ['Patract Node', nodeJupiter], ['Polkadex Node', nodePolkadex], ['parity-polkadot', nodePolkadot], ['Plasm', nodePlasm], ['Plasm Node', nodePlasm], ['Plasm Parachain Collator', nodePlasm], ['phala-substrate-node', nodePhala], ['Phala Collator', nodePhala], ['polkadot-js', nodePolkadotJs], ['Sgc', nodeSgc], ['SORA-staging Node', nodeSora], ['Stafi Node', nodeStafi], ['Stafi', nodeStafi], ['subsocial-node', nodeSubsocial], ['substrate-node', nodeSubstrate], ['Equilibrium Node', nodeEquilibrium], ['Equilibrium', nodeEquilibrium], ['SUBZΞRO', nodeZero], ['Ternoa Node', nodeTernoa], ['TrustBase Node', nodeTrustBase], ['TrustBase Collator', nodeTrustBase], ['Zenlink', nodeZenlink], ['Zenlink Collator', nodeZenlink], ['SubDAO Collator', nodeSubDAO], ['Uniarts', nodeUniarts], ['Unique Node', nodeUnique]].reduce((logos, [node, logo]) => _objectSpread(_objectSpread({}, logos), {}, {
